...
static_assert(magic_enum::enum_max<const Color>() == Color::BLUE);
static_assert(magic_enum::enum_min<Directions>() == Directions::LEFT);
static_assert(magic_enum::enum_max<Directions, magic_enum::as_flags<>>() == Directions::RIGHT);
